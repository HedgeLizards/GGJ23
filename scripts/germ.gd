...
export var nutrients_gain = 10 # how many nutrients are recharged per second
...
export var min_boost = 50 # you cannot use 'boost' before you have at least 5 nutrients
